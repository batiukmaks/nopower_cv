...
emergency_shutdowns = "\n".join(
    [
        f"⚠️ Екстрені відключення ⚠️",
        f"😔 Графіки тимчасово не діють.",
        f"💡 В енергосистемі суттєвий дефіцит електроенергії.",
        f"🫶 Відключення без попередження запроваджуються, щоб зберегти баланс в енергосистемі.",
        f"\n👉 Детальніше на <a href='https://oblenergo.cv.ua/shutdowns/'>сайті</a> ОблЕнерго.",
    ]
)
...
def gpv_info_all_green(group):
    text = "\n".join(
        [
            f"💡 Ви обрали групу №{group}",
            f"🥳 Згідно з <a href='https://oblenergo.cv.ua/shutdowns/'>графіком</a>, сьогодні у вас не буде відключень.",
            f"\n❗️ У випадку дизбалансу в енергосистемі, графіки можуть змінитись."
        ]
    )
    return text
